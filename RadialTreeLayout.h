...
class RadialTreeLayout : public OgdfLayout, public ogdf::RadialTreeLayout {
    ...
    Q_PROPERTY(double levelDistance READ levelDistance WRITE levelDistance)
    ...
    Q_PROPERTY(RootSelectionType rootSelection READ rootSelection WRITE rootSelection)
